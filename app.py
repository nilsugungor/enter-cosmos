...
#needs to be implemented in the frontend
...
def interpretations(): return jsonify({"planet_sign": planet_sign_text, "planet_house": planet_house_text})

#pdf style may change it later
